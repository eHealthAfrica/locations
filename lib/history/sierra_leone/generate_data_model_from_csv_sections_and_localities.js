...
var task_folder = '../../../history/sierra_leone/add_sections_localities_admin_divisions'
...
var correctDistrictNames = {
  ...
  filter: function (location) {
    return ['bonthe island', 'western urban', 'western rural'].indexOf(location.name) < 0
  }
}

// adds the path to the files with the new data
var addSourcesPath = function (location) {
  return _.assign(location, { path: task_folder + '/sources/' + location.name + '_village.csv' })
}
